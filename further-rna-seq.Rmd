...
## Some Examples: Diet habits

- Analysis of 'foursquare' check-ins to reveal food and drink habits
(You Are What You Eat (and Drink): Identifying Cultural Boundaries by Analyzing Food and Drink Habits in Foursquare. Silva et al (2014))
![food-pca](images/food-pca.png)


## Some Examples: Athlete Performance

Olympic heptathalon results from 1988 - Everitt and Hothorn (2006) A handbook of statistical analyses using R

```{r echo=FALSE}
#http://rcourse.iop.kcl.ac.uk/2014/5fri/3/updated_kh_pca_slides_030614.pdf
data(heptathlon, package="HSAUR")
heptathlon$hurdles <- max(heptathlon$hurdles) - heptathlon$hurdles
heptathlon$run200m <- max(heptathlon) - heptathlon$run200m
heptathlon$run800m <- max(heptathlon) - heptathlon$run800m
pairs(heptathlon[,-which(colnames(heptathlon) == "score")])
```
...
![scree](https://upload.wikimedia.org/wikipedia/commons/e/e0/Yamnuska_bottom_cliff.jpg)
